...
var Row = module.exports = function Row(data, table) {
  var self = this
  if (table && table.Row && typeof table.Row === 'function') {
    var model = function () {}
...
Row.prototype.initialize = function (data, table) {
  ...
  //tire um snapshot dos dados para salvar apenas () o que foi alterado
  self._data = self._data || {}
  self._table = table
  self._db = table.db

  Object.getOwnPropertyNames(data).forEach(function (prop) {
    var desc = Object.getOwnPropertyDescriptor(data, prop)
